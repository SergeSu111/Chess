...
public class BOARD {
    ...
    public static void highLightMoves(ChessPosition startPostion, ChessBoard chessBoard, String teamColor, Collection<ChessMove> validMoves){
        for (int row = 0; row < 10; row++) {
            if (row == 0 || row == 9) {
                //print out the top and bottom line headers
                String[] header = new String[]{"  ", "a", "b", "c", "d", "e", "f", "g", "h"};
                ...
                for (int col = 0; col < 10; col++) {
                    if (col == 0 || col == 9) {
                        ...
                        if (teamColor.equalsIgnoreCase("white")){
                            if(validMoves.contains(new ChessMove(startPostion,new ChessPosition(9-row,col),null))) {
                                System.out.print(SET_BG_COLOR_GREEN);
                            }
                        } else {
                            if(validMoves.contains(new ChessMove(startPostion,new ChessPosition(row,9-col),null))) {
                                System.out.print(SET_BG_COLOR_GREEN);
                            }
                        }
                        if (currentPiece != null) {
